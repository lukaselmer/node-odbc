...
- Prebuilt binaries for `darwin-arm64` and `win32-x64` alongside `linux-x64`, each built and
...
- `eslint`, `@eslint/js`, `@stylistic/eslint-plugin` and `globals`, replaced by `oxlint` and `oxfmt`
